...
![w:520](images/yokocho_keyvisual.jpg) ![w:520](images/dokidoki_keyvisual.jpg)

---

<!-- _class: projectA -->

<style scoped>section p:last-of-type { font-size: 14px; color: #777; }</style>

# 企業連携課題① 昭和レトロ横丁のショート動画

![w:800](images/yokocho_keyvisual.jpg)

出典：京都・二条駅 昭和レトロ横丁 駄菓子ワールド https://showa082.com/

<!-- 連携先の紹介。依頼の背景や担当者の話があればここで -->
...
| 項目 | 内容 |
|---|---|
| 連携先 | **京都・二条駅 昭和レトロ横丁 駄菓子ワールド**（二条駅前 Bivi二条 2階） |
| お店 | 駄菓子を中心に、昭和テイストの懐かしいお菓子や玩具を売るお店 |
| 尺・形 | **15〜30秒の縦動画**（TikTok・リール・ショート向け） |
| 制作 | **ひとりで** 1本 |
| 撮影 | **11/6 現地でフィールドワーク**（スマホ1台でOK） |
| 納品 | 第8回（11/20）上映会 → 企業へ納品 |

**駄菓子・ラムネ・昭和の看板。スマホの縦画面でどう切り取る？**
...
# 企業連携課題② 「どきどきサイクリング」のPV

![w:760](images/dokidoki_keyvisual.jpg)

出典：政府広報オンライン「Forever安全 どきどきサイクリング」 https://www.gov-online.go.jp/useful/202603/video-308522.html

<!-- 政府広報・警察庁のシミュレーションゲーム風CM。ここでFull版を再生してもよい -->
...
| 項目 | 内容 |
|---|---|
| 題材 | 政府広報オンライン × 警察庁 **「Forever安全 どきどきサイクリング」** |
| 中身 | **シミュレーションゲーム風** の自転車交通安全CM。主人公・乗子（のるこ）と3人の警察官 |
| 背景 | **2026年4月から自転車の交通違反に「青切符」** が導入された |
| 作るもの | ゲームの **プレイ映像 ＋ 素材** にナレーション・テロップ・音をつけた **PV** |
| 制作 | **チーム** で役割分担（構成・収録・編集・音・テロップ…） |
| 納品 | 第15回（1/22）上映会 → 納品 |

**「ルールを守ろう」の啓発と「このゲーム気になる！」の魅力、両方を1本に**

<!-- ゲームの実体（プレイ可能なものか、素材はどこから提供されるか）は連携先と確認のうえ補足する -->
...
- **公開**：2026年3月16日、政府広報オンライン
- **声の出演**：草尾毅さん（警察官3役）、夏目妃菜さん（主人公・乗子）
- **30秒版が3本**
  - 一時停止は必ず止まろう
  - スピードの出し過ぎ＆逆走は危険
  - ながらスマホ＆飲酒運転は絶対NG
- **対象**：自転車に乗る若い世代 ＝ **みなさん自身**

> 自分たちが対象の啓発を、自分たちの言葉と映像で作り直す
...
![w:640](images/yokocho_keyvisual.jpg)

https://showa082.com/

<!-- 公式サイトをブラウザで開く。あわせて、SNSで「昭和レトロ 横丁」「駄菓子屋」のショート動画を2〜3本再生する（URLは授業前に用意） -->

---

# 見るときのチェックポイント（ショート動画）
...
| 見るところ | 問い |
|---|---|
| **つかみ** | 最初の3秒で「ゲームっぽさ」をどう出している？ |
| **啓発** | ルールの説明はどこに、どの順番で入っている？ |
| **キャラ** | 主人公と警察官、それぞれの役割は？ |
| **音** | 声・BGM・効果音で「ゲーム感」をどう作っている？ |
| **メッセージ** | 最後に残る一言は？ |

**後半のPVでは、これを自分たちの尺と構成で設計し直す**
...
# 実例：どきどきサイクリングの素材は使える？

政府広報オンラインのコンテンツには **利用ルール** がある

- サイトに **「コンテンツの利用・著作権等について」** のページがある
- 動画には **「動画コンテンツ貸出申請フォーム」** が用意されている
- 声優の音声やキャラクターのイラストには、**別の権利者** がいる可能性がある

> **公的機関のコンテンツでも「勝手に使える」わけではない。**
> 課題②で使う素材は、講師を通して確認・申請したものだけを使う
...
### この授業でやること
- 企業連携課題を **2本** 作る：昭和レトロ横丁のショート動画（個人・縦）と、どきどきサイクリングのPV（チーム・横）
